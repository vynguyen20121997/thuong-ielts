      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 contact-reveal text-left">
            ...
            <h2 className="font-serif text-3xl md:text-5xl font-bold tracking-tight text-[#1A1A1A] leading-tight mb-6">
              Bắt Đầu Lộ Trình <br />
              Chinh Phục IELTS <br />
              Ngay Hôm Nay
            </h2>
            ...
            <div className="space-y-6 mb-12" id="contact-channels-list">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h4 className="text-2xs text-[#1A1A1A]/50 mb-0.5 font-medium">Hotline Tư Vấn</h4>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h4 className="text-2xs text-[#1A1A1A]/50 mb-0.5 font-medium">Email Hỗ Trợ</h4>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h4 className="text-2xs text-[#1A1A1A]/50 mb-0.5 font-medium">Địa Chỉ Lớp Học</h4>
            ...
            <div className="pt-6 border-t border-black/10">
              <p className="text-2xs text-[#1A1A1A]/50 mb-3 font-medium">Kênh Học Tập Cộng Đồng</p>
              <div className="flex gap-4 text-xs font-bold text-[#1A1A1A]/80">
                <a href="#facebook" className="hover:text-[#14532D] transition-colors">
                  Facebook Page
                </a>
                <span className="text-[#1A1A1A]/20">•</span>
                <a href="#youtube" className="hover:text-[#14532D] transition-colors">
                  TikTok Series
                </a>
                <span className="text-[#1A1A1A]/20">•</span>
                <a href="#group" className="hover:text-[#14532D] transition-colors">
                  Group Học Thuật
                </a>
              </div>
            </div>
              ...
              {!formSubmitted ? (
                <form onSubmit={handleSubmit} className="space-y-6" id="consultation-form">
                  ...
                  <div className="text-left">
                    <label
                      htmlFor="fullname"
                      className="block text-xs font-medium text-[#1A1A1A]/60 mb-2"
                    >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="text-left">
                      ...
                      >
                        <option value="zero" className="bg-white text-[#1A1A1A]">
                          Mất Gốc / Chưa biết gì
                        </option>
                        <option value="basic" className="bg-white text-[#1A1A1A]">
                          Đã biết cơ bản
                        </option>
                        <option value="level-4-5" className="bg-white text-[#1A1A1A]">
                          Band 4.0 - 5.0 IELTS
                        </option>
                        <option value="level-5-6" className="bg-white text-[#1A1A1A]">
                          Band 5.5 - 6.0 IELTS
                        </option>
                      </select>
                    </div>
                    ...
                    <div className="text-left">
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 bg-white border border-black/10 rounded-xl text-sm text-[#1A1A1A] focus:outline-none focus:border-[#14532D] transition-all font-sans"
                      >
                        <option value="6.0" className="bg-white text-[#1A1A1A]">
                          IELTS 6.0
                        </option>
                        <option value="6.5" className="bg-white text-[#1A1A1A]">
                          IELTS 6.5 (Tiêu chuẩn)
                        </option>
                        <option value="7.0" className="bg-white text-[#1A1A1A]">
                          IELTS 7.0 (Du học)
                        </option>
                        <option value="7.5" className="bg-white text-[#1A1A1A]">
                  ...
                  <p className="text-2xs text-center text-[#1A1A1A]/40 font-mono font-bold">
                ...
                >
                  ...
                  <div className="p-5 bg-black/5 border border-black/10 rounded-2xl text-left max-w-md mx-auto space-y-3">
                    <h4 className="text-xs font-medium text-[#14532D] ">Thông tin tóm tắt:</h4>
