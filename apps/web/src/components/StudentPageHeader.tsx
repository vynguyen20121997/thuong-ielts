  ...
  return (
    <div className="relative overflow-hidden pt-28 md:pt-32 pb-4">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        <div className="mb-4">
          <span className="relative inline-block text-6xl md:text-8xl font-bold tracking-tighter text-brand leading-none">
        ...
        <h1 className="text-2xl md:text-4xl font-bold tracking-tight text-ink leading-tight mb-5 text-balance">
          {heading}
        </h1>
