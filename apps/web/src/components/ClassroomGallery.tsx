...
export const classroomImages = [
  { src: "/images/classroom/classroom-01.jpg", alt: "Học viên trao đổi bài tập theo nhóm trong lớp" },
  { src: "/images/classroom/classroom-02.jpg", alt: "Khoảnh khắc cả lớp cùng chụp ảnh" },
  { src: "/images/classroom/classroom-03.jpg", alt: "Lớp học cùng tham gia hoạt động" },
  { src: "/images/classroom/classroom-04.jpg", alt: "Học viên tập trung làm bài tại lớp" },
  { src: "/images/classroom/classroom-05.jpg", alt: "Học viên thảo luận cùng bạn học" },
  { src: "/images/classroom/classroom-06.jpg", alt: "Hoạt động tương tác trong giờ học" },
  { src: "/images/classroom/classroom-07.jpg", alt: "Các nhóm học viên cùng trao đổi" },
  { src: "/images/classroom/classroom-08.jpg", alt: "Lớp học cùng thực hành bài tập" },
  { src: "/images/classroom/classroom-09.jpg", alt: "Học viên làm việc nhóm trong lớp" },
  { src: "/images/classroom/classroom-10.jpg", alt: "Nhóm học viên cùng phân tích bài tập" },
  { src: "/images/classroom/classroom-11.jpg", alt: "Hoạt động học tập tại lớp" },
  { src: "/images/classroom/classroom-12.jpg", alt: "Học viên cùng làm bài tại The IELTS Workshop" },
  { src: "/images/classroom/classroom-13.jpg", alt: "Học viên tập trung luyện tập tại nhà" },
  { src: "/images/classroom/classroom-14.jpg", alt: "Lớp học cùng thảo luận bài tập" },
  { src: "/images/classroom/classroom-15.jpg", alt: "Khoảnh khắc kỷ niệm của lớp học" },
  { src: "/images/classroom/classroom-16.jpg", alt: "Học viên làm việc nhóm trong giờ học" },
  { src: "/images/classroom/classroom-17.jpg", alt: "Ảnh lưu niệm cùng cô Thương và học viên" },
  { src: "/images/classroom/classroom-18.jpg", alt: "Học viên tập trung làm bài trong lớp" },
  { src: "/images/classroom/classroom-19.jpg", alt: "Học viên cùng chụp ảnh sau giờ học" },
  { src: "/images/classroom/classroom-20.jpg", alt: "Khoảnh khắc cả lớp vui vẻ bên nhau" },
  { src: "/images/classroom/classroom-21.jpg", alt: "Học viên tham gia hoạt động tương tác" },
  { src: "/images/classroom/classroom-22.jpg", alt: "Hoạt động nhóm trong không gian lớp học" },
  { src: "/images/classroom/classroom-23.jpg", alt: "Học viên cùng hoàn thành bài tập" },
  { src: "/images/classroom/classroom-24.jpg", alt: "Thảo luận và hỗ trợ nhau trong lớp" },
  { src: "/images/classroom/classroom-25.jpg", alt: "Cả lớp cùng học tập tập trung" },
  { src: "/images/classroom/classroom-26.jpg", alt: "Học viên luyện tập tại lớp" },
  { src: "/images/classroom/classroom-27.jpg", alt: "Buổi học trực tuyến của lớp" },
  { src: "/images/classroom/classroom-28.jpg", alt: "Học viên cùng trao đổi bài tập" },
  { src: "/images/classroom/classroom-29.jpg", alt: "Học viên chăm chú làm bài trong lớp" },
  { src: "/images/classroom/classroom-30.jpg", alt: "Buổi học trực tuyến cùng học viên" },
  { src: "/images/classroom/classroom-31.jpg", alt: "Học viên cùng phân tích bài tập" },
  { src: "/images/classroom/classroom-32.jpg", alt: "Khoảnh khắc học viên luyện tập tại lớp" },
...
const featuredImages = classroomImages.filter((image) => featuredImageSources.has(image.src));
const featuredMedia = [
  ...featuredImages.map((image) => ({ ...image, type: "image" as const })),
  ...classroomVideos.slice(2, 4).map((video) => ({ ...video, type: "video" as const })),
];

export default function ClassroomGallery() {
  return (
    <section id="classroom-gallery" className="border-b border-black/5 bg-mist py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        <Reveal className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-ink/70">
            Tại <strong className="font-semibold text-brand">Thương Hồ&apos;s Class</strong>, các{" "}
            <strong className="font-semibold text-brand">hoạt động tương tác đa dạng</strong> giúp học viên thực hành tự nhiên trong một không khí{" "}
            <strong className="font-semibold text-brand">thoải mái và hứng khởi</strong>.
          </p>
        </Reveal>

        <Reveal delay={0.08}>
          <Carousel ariaLabel="Slideshow hình ảnh lớp học" autoPlayInterval={4800}>
