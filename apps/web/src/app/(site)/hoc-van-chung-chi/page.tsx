...
export default function EducationPage() {
  return <main className="min-h-screen bg-white pb-24 pt-28 md:pt-32"><div className="mx-auto max-w-6xl px-6 md:px-12">
    ...
    <header className="max-w-3xl border-b-2 border-brand/15 pb-12 pt-8"><p className="text-sm font-bold uppercase tracking-[0.14em] text-brand/60">Hồ sơ chuyên môn</p><h1 className="mt-4 text-4xl font-bold tracking-tight text-brand md:text-6xl">Học vấn & Chứng chỉ</h1></header>
    ...
    <Link href="/phuong-phap" className="group inline-flex items-center gap-2 rounded-full bg-brand px-5 py-3 text-sm font-bold text-white hover:bg-brand-deep">Tìm hiểu phương pháp giảng dạy <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" /></Link>
  </div></main>;
}
