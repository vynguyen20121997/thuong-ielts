      ...
      <div className="relative z-10 max-w-7xl mx-auto gutter">
        ...
        <div className="max-w-2xl mb-10">
          ...
          <p className="text-ink/70 text-sm md:text-base leading-relaxed mt-5">
            Viết trong {WRITING_MINUTES} phút, tối thiểu {WRITING_MIN_WORDS} từ,
            có bấm giờ và đếm từ như phòng thi. Viết xong bấm một nút để máy soi
            trước những lỗi dễ thấy — lạc đề, thiếu kết bài, ý không có ví dụ —
            rồi mới gửi bài cho cô chấm theo barem.
          </p>
        </div>
        ...
        <p className="max-w-2xl text-2xs text-ink/65 leading-relaxed mb-10 rounded-xl border border-black/5 bg-[#FAFAF8] px-4 py-3">
          Phần kiểm tra tự động <b className="text-ink/70">không chấm band</b>{" "}
          và không thay được người chấm. Writing được chấm theo bốn tiêu chí mà
          chỉ giáo viên cân nhắc cùng lúc được; máy chỉ giúp bạn không nộp một
          bài còn thiếu những thứ sửa được trong năm phút.
        </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {prompts.map((p) => (
            ...
            >
              ...
              <h2 className="text-lg font-bold tracking-tight text-ink mt-4">
                {p.title}
              </h2>
              ...
              <span className="mt-4 pt-3 border-t border-black/5 flex items-center justify-between text-2xs font-medium text-ink/65">
